    ...
    <section id="testimonial">
      ...
      <div className="control container d-flex justify-content-center">
        <button
          ...
          className="btn btn-light my-3 mr-3 d-flex justify-content-center align-items-center"
          style={{
            width: "44px",
            height: "44px",
        ...
        <button
          onClick={handleNext}
          className="btn btn-light my-3 d-flex justify-content-center align-items-center"
          style={{
            width: "44px",
            height: "44px",
            border: "#C4C4C4 solid 1px",
